            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">
                            <i class="fa fa-table"></i> Disease Management
                        </li>
                        <div style="text-align:right; margin-top: -1.2pc;"><a href="admin_disease.php?action=new">New Disease</a> <i id="createDefectBtn" class="fa fa-plus-circle fa-lg"></i></div>
